...
// @Param tags query string true "Comma-separated list of tags to search for" example:"nature,wildlife,landscape"
...
// @Param limit query integer false "Number of images to return (1-100, default: 20)" minimum(1) maximum(100) default(20)
// @Success 200 {object} Response "Images retrieved successfully with relevance scoring and pagination"
